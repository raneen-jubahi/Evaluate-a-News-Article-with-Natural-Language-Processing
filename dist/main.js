...
/* base.css */
/* عام: تعيين الحافات والإعدادات الأساسية */
* {
  margin: 0;
  padding: 0;
...
body {
  ...
  align-items: center;
  height: 100vh;
  background: linear-gradient(135deg, #74ebd5, #9face6); /* إضافة خلفية بتدرج لوني */
}

.container {
  text-align: center;
  background: rgba(255, 255, 255, 0.9); /* جعل الخلفية شفافة قليلاً */
  padding: 40px; /* زيادة التباعد الداخلي */
  border-radius: 15px; /* زيادة الاستدارة في الزوايا */
  box-shadow: 0 6px 15px rgba(0, 0, 0, 0.2); /* تعزيز الظل */
  max-width: 500px;
  width: 100%;
  transition: transform 0.3s ease; /* إضافة تأثير الترجمة عند التحويم */
}
.container:hover {
  transform: translateY(-10px); /* تحريك العنصر للأعلى عند التحويم */
}`, "",{"version":3,"sources":["webpack://./src/client/styles/base.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB,aAAA;AAEA,2CAAA;AACA;EACE,SAAA;EACA,UAAA;EACA,sBAAA;AACF;;AAEA;EACE,gCAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,aAAA;EACA,qDAAA,EAAA,2BAAA;AACF;;AAEA;EACE,kBAAA;EACA,oCAAA,EAAA,6BAAA;EACA,aAAA,EAAA,0BAAA;EACA,mBAAA,EAAA,+BAAA;EACA,yCAAA,EAAA,eAAA;EACA,gBAAA;EACA,WAAA;EACA,+BAAA,EAAA,oCAAA;AACF;AACE;EACE,4BAAA,EAAA,oCAAA;AACJ","sourceRoot":""}]);
// Exports
...
footer {
  ...
  bottom: 0;
  width: 100%;
}`, "",{"version":3,"sources":["webpack://./src/client/styles/footer.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB,eAAA;AAEA,2BAAA;AACA;EACI,sBAAA;EACA,YAAA;EACA,kBAAA;EACA,aAAA;EACA,eAAA;EACA,SAAA;EACA,WAAA;AACJ","sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* form.css */
form {
  background: transparent; /* إزالة الخلفية من الفورم */
}
...
button {
  ...
  color: white;
  border: none;
  border-radius: 25px; /* جعل الزوايا مستديرة بالكامل */
  font-size: 18px; /* تكبير حجم الخط */
  cursor: pointer;
  transition: background-color 0.3s ease, transform 0.3s ease; /* إضافة تأثيرات عند التحويم */
}
button:hover {
  background-color: #0056b3;
  transform: scale(1.05); /* تكبير الزر عند التحويم */
}`, "",{"version":3,"sources":["webpack://./src/client/styles/form.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB,aAAA;AAEA;EACI,uBAAA,EAAA,4BAAA;AACJ;;AAEE;EACE,WAAA;EACA,aAAA,EAAA,0BAAA;EACA,mBAAA,EAAA,0BAAA;EACA,sBAAA;EACA,kBAAA;EACA,eAAA;EACA,wCAAA,EAAA,kBAAA;AACJ;;AAEE;EACE,WAAA;EACA,aAAA,EAAA,0BAAA;EACA,yBAAA;EACA,YAAA;EACA,YAAA;EACA,mBAAA,EAAA,gCAAA;EACA,eAAA,EAAA,mBAAA;EACA,eAAA;EACA,2DAAA,EAAA,8BAAA;AACJ;AACI;EACE,yBAAA;EACA,sBAAA,EAAA,2BAAA;AACN","sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
header h1 {
  ...
  letter-spacing: 2px; /* توسيع التباعد بين الأحرف */
}
...
}`, "",{"version":3,"sources":["webpack://./src/client/styles/header.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB,eAAA;AAEA;EACI,mBAAA;AACJ;;AAEE;EACE,mBAAA;EACA,eAAA,EAAA,mBAAA;EACA,WAAA;EACA,yBAAA,EAAA,8BAAA;EACA,mBAAA,EAAA,6BAAA;AACJ;;AAEE;EACE,WAAA,EAAA,mBAAA;EACA,eAAA;EACA,gBAAA,EAAA,uBAAA;AACJ","sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
___CSS_LOADER_EXPORT___.push([module.id, `@charset "UTF-8";
/* resets.css */
/* تعيين الحافات والإعدادات الأساسية */
* {
  margin: 0;
  padding: 0;
  box-sizing: border-box;
}`, "",{"version":3,"sources":["webpack://./src/client/styles/resets.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB,eAAA;AAEA,sCAAA;AACA;EACI,SAAA;EACA,UAAA;EACA,sBAAA;AACJ","sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
